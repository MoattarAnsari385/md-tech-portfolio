...
export default function Skills() {
    ...
    const skills = [
      ...
      { icon: <BsChatDots />, name: "Chatbots" },
      { icon: <SiTensorflow />, name: "AI/ML" },
      { icon: <FaPython />, name: "LangChain" },
  
      { icon: <SiAdobepremierepro />, name: "Premiere Pro" },
      { icon: <FaVideo />, name: "Final Cut Pro" },
  ...
  useEffect(() => {
    ...
    return (
      ...
      className="h-1/2 w-full p-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden">
          ...
          <motion.h2
            className="text-4xl mt-5 sm:text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-[#f1c8d2] via-[#00bf8f] to-[#302b63] z-10"
        ...
        <motion.p className='mt-2 mb-8 text-white/90 text-base sm:text sm:text-lg z-10'
        ...
        <div className='relative w-full overflow-hidden'>
          ...
          {repeated.map((s, i) => (
            ...
            >
                <span className='hover:scale-125 transition-transform duration-300 text-5xl text-[#1cd8d2]'>
