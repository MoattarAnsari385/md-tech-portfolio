...
export default function Home() {
  const roles = useMemo(() => ["Web Developer", "Software Developer", "AI Engineer", "Video Editor", "Graphic Designer"], []);
    ...
    <section id="home" className="w-full h-screen relative bg-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          ...
          >
            I build modern web and software solutions, create agentic AI systems, and craft impactful visuals through video editing and graphic design.
          </motion.p>
